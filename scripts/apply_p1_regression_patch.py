...
# Global browser boundary, exact posting identity, and target rebinding.
replace_once(
...
# Lever evidence subsets and one locked readiness snapshot.
replace_once(
...
# Regression tests for all six P1 findings.
replace_once(
