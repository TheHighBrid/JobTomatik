...
The evaluator validates report provenance fields and count consistency (including
that reviewed submissions cannot exceed confirmations and distinct sites cannot
exceed the candidate corpus). Invalid aggregate reports remain visible with explicit
validation issues but receive no certification effect.
