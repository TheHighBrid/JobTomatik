...
def test_complete_physical_proof_can_satisfy_final_gate():
    evidence = {
        "adapter": "ashby",
        "application_id": 123,
        "target_url": "https://jobs.ashbyhq.com/company/12345678-1234-4123-8123-123456789abc/application",
        "runtime": "android_native_chrome_cdp",
        "confirmation_sufficient": True,
        "confirmation_evidence_type": "confirmation_page",
        "confirmation_final_url": "https://jobs.ashbyhq.com/company/12345678-1234-4123-8123-123456789abc/application",
