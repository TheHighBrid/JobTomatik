"""Current Lever Phase B preparation using the role-aware v5 material renderer.

Only material preparation differs from the existing service. Review, show, runtime,
approval, queueing, and submission boundaries remain owned by the existing current
Lever service.
"""
...
from app.services.material_generation_v5_policy import generate_application_material
...
def prepare_current_lever_materials(
    ...
    *,
    ...
    """Generate v5 role-aware materials and open the existing explicit review task."""
