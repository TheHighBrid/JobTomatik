"""Read-only Day 42 exact-artifact publication-readiness evaluator for v2.1.0.

A passing result means the owner may invoke the separate hardened publisher for one
exact current-main commit and one exact prebuilt APK candidate. This module cannot
create a tag, GitHub release, artifact, or submission authority.
"""
...
DAY42_RELEASE_VERSION = "v2.1.0"
DAY42_RELEASE_TAG = "v2.1.0"
...
DAY42_REQUIRED_WORKFLOWS = (
    ...
    "Day 41 frozen-v1 compatibility drill",
...
def build_day42_publish_readiness(
    *,
    ...
    """Evaluate whether the exact prebuilt v2.1.0 candidate may be published."""
    ...
    result: dict[str, Any] = {
        ...
        "next_action": "invoke_separate_exact_artifact_v21_publisher" if eligible else "satisfy_day42_publish_blockers",
        "invariants": {
            "readiness_evaluator_never_publishes": True,
            "publisher_must_recheck_main_before_publication": True,
            "publisher_must_refuse_existing_v21_tag": True,
