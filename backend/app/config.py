...
class Settings(BaseSettings):
    ...
    # Runtime-affinity and retained handoff paths must also be available through
    # BaseSettings because Android-managed API/worker processes intentionally start
    # from a sanitized environment. Process environment still wins when explicitly set.
